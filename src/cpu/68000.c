...
void M68K_STATE_REGISTER(const char* TYPE, int* CPU_BASE)
{
	...
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "D", M68K_D0, 8);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "A", M68K_A0, 8);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "PC", M68K_PC, 1);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "USP", M68K_USP, 1);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "ISP", M68K_ISP, 1);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "VBR", M68K_VBR, 1);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "SFC", M68K_SFC, 1);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "DFC", M68K_DFC, 1);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "CACR", M68K_CACR, 1);
