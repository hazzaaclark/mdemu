...
U32* CPU_ACCESS_REGISTERS(CPU_68K_REGS REGISTER, unsigned VALUE)
{
	...
	switch(REGISTER)
	{
		case M68K_REG_D0: CPU_68K->REGISTER_BASE[0] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[0];
		case M68K_REG_D1: CPU_68K->REGISTER_BASE[1] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[1];
		case M68K_REG_D2: CPU_68K->REGISTER_BASE[2] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[2];
		case M68K_REG_D3: CPU_68K->REGISTER_BASE[3] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[3];
		case M68K_REG_D4: CPU_68K->REGISTER_BASE[4] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[4];
		case M68K_REG_D5: CPU_68K->REGISTER_BASE[5] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[5];
		case M68K_REG_D6: CPU_68K->REGISTER_BASE[6] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[6];
		case M68K_REG_D7: CPU_68K->REGISTER_BASE[7] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[7];
		
		case M68K_REG_A0: CPU_68K->REGISTER_BASE[8] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[8];
		case M68K_REG_A1: CPU_68K->REGISTER_BASE[9] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[9];
		case M68K_REG_A2: CPU_68K->REGISTER_BASE[10] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[10];
		case M68K_REG_A3: CPU_68K->REGISTER_BASE[11] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[11];
		case M68K_REG_A4: CPU_68K->REGISTER_BASE[12] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[12];
		case M68K_REG_A5: CPU_68K->REGISTER_BASE[13] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[13];
		case M68K_REG_A6: CPU_68K->REGISTER_BASE[14] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[14];
		case M68K_REG_A7: CPU_68K->REGISTER_BASE[15] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE); return CPU_68K->REGISTER_BASE[15];

		case M68K_REG_PC: return (U32*)(uintptr_t)M68K_RETURN_ADDRESS(CPU_68K->PC);

		case M68K_REG_USP:
			if(FLAG_S) CPU_68K->REGISTER_BASE[15] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE);
			return;

		case M68K_REG_ISP:
			if(FLAG_S) CPU_68K->REGISTER_BASE[14] = (U32*)(uintptr_t)M68K_RETURN_ADDRESS(VALUE);
			return;
