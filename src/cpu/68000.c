...
/* 28/06/2024 - THIS IS HERE AS A AUTOGENERATED STUB SUCH THAT MAKEFILE WILL SHUT UP */
/* ABOUT "muh undefined reference" */

void M68K_SAVE_REGISTER(char* TYPE, int* CPU, char REGISTER, int VALUE){}
