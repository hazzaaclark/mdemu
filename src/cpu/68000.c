...
{
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "D", M68K_REG_D);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "A", M68K_REG_A);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "PC", M68K_REG_PC);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "USP", M68K_REG_USP);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "ISP", M68K_REG_ISP);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "VBR", M68K_REG_VBR);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "SFC", M68K_REG_SFC);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "DFC", M68K_REG_DFC);
	M68K_SAVE_REGISTER(TYPE, CPU_BASE, "CACR", M68K_REG_CACR);
