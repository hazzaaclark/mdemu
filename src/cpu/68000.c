...
#define         M68K_CALLBACK_INT			CPU_68K->INTERRUPT_CALLBACK(NULL);		
#define		M68K_CALLBACK_RESET			CPU_68K->RESET_INTERRUPT();
#define		M68K_CALLBACK_FUNC			CPU_68K->CPU_FUNC_CALLBACK(NULL);
...
{
	struct CPU_68K* CPU_68K;
	M68K_CALLBACK_INT + (S32)malloc(sizeof(CALLBACK) + sizeof(CPU_68K->INTERRUPT_CALLBACK(NULL)));
}
...
{
	struct CPU_68K* CPU_68K;
	M68K_CALLBACK_FUNC + (S32)malloc(sizeof(CALLBACK) + sizeof(CPU_68K->CPU_FUNC_CALLBACK(NULL)));
}
