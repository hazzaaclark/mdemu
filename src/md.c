...
void MD_INIT()
{
    struct CPU_68K* CPU_BASE = malloc(sizeof(CPU_68K));
    M68K_INIT();
    ...
    {
        CPU_BASE->MEMORY_MAP[i].MEMORY_READ_8 += M68K_READ_8(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS);
        CPU_BASE->MEMORY_MAP[i].MEMORY_WRITE_8 += M68K_WRITE_8(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS, CPU_BASE->MEMORY_POINTER);
        CPU_BASE->MEMORY_MAP[i].MEMORY_READ_16 += M68K_READ_16(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS);
        CPU_BASE->MEMORY_MAP[i].MEMORY_WRITE_16 += M68K_WRITE_16(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS, CPU_BASE->MEMORY_POINTER);

        CPU_BASE->Z80_MEM[i].READ = Z80_READ(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS);
        CPU_BASE->Z80_MEM[i].WRITE = Z80_WRITE(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS, CPU_BASE->MEMORY_POINTER);
    }
    ...
    {
        CPU_BASE->MEMORY_MAP[i].MEMORY_READ_8 +=  VDP_READ_BYTE(CPU_BASE->MEMORY_DATA, (U8*)CPU_BASE->MEMORY_ADDRESS);
        CPU_BASE->MEMORY_MAP[i].MEMORY_WRITE_8 += VDP_WRITE_BYTE(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS, CPU_BASE->MEMORY_POINTER);
        CPU_BASE->MEMORY_MAP[i].MEMORY_READ_16 += VDP_READ_WORD(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS);
        CPU_BASE->MEMORY_MAP[i].MEMORY_WRITE_16 += VDP_WRITE_WORD(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS, CPU_BASE->MEMORY_POINTER);
    }
    ...
    {
        CPU_BASE->MEMORY_MAP[0xA1].MEMORY_READ_8 = CTRL_READ_BYTE(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS);
        CPU_BASE->MEMORY_MAP[0xA1].MEMORY_WRITE_8 = CTRL_WRITE_BYTE(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS, CPU_BASE->MEMORY_POINTER);
        CPU_BASE->MEMORY_MAP[0xA1].MEMORY_READ_8 = CTRL_READ_WORD(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS);
        CPU_BASE->MEMORY_MAP[0xA1].MEMORY_WRITE_8 = CTRL_WRITE_WORD(CPU_BASE->MEMORY_DATA, CPU_BASE->MEMORY_ADDRESS, CPU_BASE->MEMORY_POINTER);
...
void MD_BUS_REQ(unsigned STATE, unsigned CYCLES)
{
    ...
    else
    {
        ...
        {
            CPU_68K->MEMORY_MAP[0xA0].MEMORY_READ_8 = M68K_READ_8(CPU_68K->MEMORY_DATA, CPU_68K->MEMORY_ADDRESS);
            CPU_68K->MEMORY_MAP[0xA0].MEMORY_WRITE_8 = M68K_WRITE_8(CPU_68K->MEMORY_DATA, CPU_68K->MEMORY_ADDRESS, CPU_68K->MEMORY_POINTER);
            CPU_68K->MEMORY_MAP[0xA0].MEMORY_READ_16 = M68K_READ_16(CPU_68K->MEMORY_DATA, CPU_68K->MEMORY_ADDRESS);
            CPU_68K->MEMORY_MAP[0xA0].MEMORY_WRITE_16 = M68K_WRITE_16(CPU_68K->MEMORY_DATA, CPU_68K->MEMORY_ADDRESS, CPU_68K->MEMORY_POINTER);
        }
    }
