...
static inline VDP_ARC::HORIZONTAL_COUNTER* GET_HORIZONTAL_COUNTER(void)
{
    ...
    /* THIS IF ELSE STATEMENT IS MEANT TO REPRESENT A CLOCK-ACCURATE */
    /* EMULATION OF THE VDP H40 INTERLACE */

    /* USING CORRESPONDING HEX VALUES TO REPRESENT EACH VALUE */
    /* OF THE HORIZONTAL AND VERTICAL INTERLACE */
